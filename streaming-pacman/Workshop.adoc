...
First things first, clone this github repo to your local machine:
+
[source,bash]
----
git clone --branch streaming-pacman-workshop --single-branch https://github.com/gianlucanatali/demo-scene.git
