...
resource "aws_cloudfront_distribution" "pacman" {
  enabled         = true
  is_ipv6_enabled = true
  comment         = "pacman"
  default_root_object = "index.html"
  origin {
    domain_name = aws_s3_bucket.pacman.bucket_domain_name
  ...
  origin {
    ...
    //origin_path="/${aws_api_gateway_stage.event_handler_v1.stage_name}${aws_api_gateway_resource.event_handler_resource.path}"
